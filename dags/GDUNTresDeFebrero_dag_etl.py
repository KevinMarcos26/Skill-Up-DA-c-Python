...
# Universidad
university = 'GrupoD_tres_de_febrero_universidad'
date_format = '%Y-%m-%d'
...
default_args = {
    ...
    'description':'Dag para la extracción, transformación y carga de la información de la Universidad Nacional de Tres de Febrero'
}
